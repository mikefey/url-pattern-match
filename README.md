...
const params = pathMatch(pattern, path); // Returns ['some-page', 'a-new-section'] - :page_slug and :section_slug from the path
...
const params = pathMatch(pattern, path); // Returns ['1/sections/5/edit']

// NO MATCH
const pattern = 'admin/pages/:page_id/sections/:section_id/edit';
const path = 'admin/sites/5/sections/2';
const params = pathMatch(pattern, path); // Returns null
